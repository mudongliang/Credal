...
main: $(ELF_SRC_DIR)/main.c $(ELF_SRC_DIR)/process_core.o $(ELF_SRC_DIR)/common.o $(ELF_SRC_DIR)/access_memory.o
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS) 
...
test:
	./main $(TESTSUITES_DIR)/simple/core > $(TESTSUITES_DIR)/simple/result
	./main $(TESTSUITES_DIR)/password/core > $(TESTSUITES_DIR)/password/result
clean:
	rm -f $(ELF_SRC_DIR)/*.o
	rm -f main
